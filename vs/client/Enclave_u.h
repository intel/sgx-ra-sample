...
sgx_status_t enclave_ra_init(sgx_enclave_id_t eid, sgx_status_t* retval, sgx_ec256_public_t key, int b_pse, sgx_ra_context_t* ctx);
sgx_status_t enclave_ra_init_def(sgx_enclave_id_t eid, sgx_status_t* retval, int b_pse, sgx_ra_context_t* ctx);
